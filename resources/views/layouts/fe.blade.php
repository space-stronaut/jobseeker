...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="/home"><img src="{{ asset('mazer/assets/images/logo/logo.svg') }}" alt="Logo" srcset=""></a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
            class="sidebar-item  ">
            <a href="{{ route('pelamaran.index') }}" class='sidebar-link'>
                <i class="bi bi-grid-fill"></i>
                        ...
                        <ul class="navbar-nav ms-auto mb-lg-0">
                            ...
                            <li class="nav-item dropdown me-3">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end notification-dropdown" aria-labelledby="dropdownMenuButton">
                                    ...
                                    @foreach (App\Models\Notification::where('recipient', Auth::user()->id)->latest()->limit(5)->get() as $item)
                                    <li class="dropdown-item notification-item">
                                        <a class="d-flex align-items-center" href="#">
                                            ...
                                            <div class="notification-text ms-4">
                                                <p class="notification-title font-bold">{{ $item->message }}</p>
                                    ...
                                    @endforeach
                                    <li>
                                        <p class="text-center py-2 mb-0"><a href="{{ route('notification.index') }}">See all notification</a></p>
                                    </li>
                                </ul>
                            </li>
                        </ul>
